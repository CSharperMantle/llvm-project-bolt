...
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds [8 x i32], ptr @arr2, <4 x i64> zeroinitializer, <4 x i64> [[VEC_IND]]
...
; CHECK-NEXT:    [[TMP3:%.*]] = getelementptr inbounds [8 x [8 x i32]], ptr @arr, <4 x i64> zeroinitializer, <4 x i64> [[VEC_PHI]], <4 x i64> [[VEC_IND]]
...
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds [8 x i64], ptr @arrX, <2 x i64> zeroinitializer, <2 x i64> [[VEC_IND]]
...
; CHECK-NEXT:    [[TMP2:%.*]] = getelementptr inbounds [8 x [8 x i64]], ptr @arrY, <2 x i64> zeroinitializer, <2 x i64> [[VEC_PHI]], <2 x i64> [[VEC_IND]]
