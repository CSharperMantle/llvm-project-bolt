...
; X86-SSE2-NEXT:    cmovbl %esi, %eax
; X86-SSE2-NEXT:    cmovbl %ecx, %edx
...
; X86-SSE4-NEXT:    cmovbl %esi, %eax
; X86-SSE4-NEXT:    cmovbl %ecx, %edx
...
; X86-AVX1-NEXT:    cmovbl %esi, %eax
; X86-AVX1-NEXT:    cmovbl %ecx, %edx
...
; X86-AVX2-NEXT:    cmovbl %esi, %eax
; X86-AVX2-NEXT:    cmovbl %ecx, %edx
...
; X86-SSE41-NEXT:    cmovbl %esi, %eax
; X86-SSE41-NEXT:    cmovbl %ecx, %edx
...
; X86-SSE42-NEXT:    movdqa %xmm2, %xmm3
...
; X86-SSE42-NEXT:    cmovbl %esi, %eax
; X86-SSE42-NEXT:    cmovbl %ecx, %edx
...
; X86-SSE2-NEXT:    cmovael %esi, %edx
; X86-SSE2-NEXT:    movd %xmm0, %esi
; X86-SSE2-NEXT:    cmovael %ecx, %eax
; X86-SSE2-NEXT:    cmpl %esi, %eax
; X86-SSE2-NEXT:    movl %edx, %ecx
; X86-SSE2-NEXT:    sbbl %edi, %ecx
...
; X86-SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [2147483647,2147483647,u,u]
; X86-SSE2-NEXT:    pcmpgtd %xmm1, %xmm2
; X86-SSE2-NEXT:    pcmpeqd %xmm3, %xmm3
; X86-SSE2-NEXT:    pxor %xmm2, %xmm3
; X86-SSE2-NEXT:    pcmpgtd {{\.?LCPI[0-9]+_[0-9]+}}, %xmm1
...
; X86-SSE2-NEXT:    retl
;
; X64-SSE2-LABEL: test_v2i32:
; X64-SSE2:       # %bb.0:
; X64-SSE2-NEXT:    movdqa {{.*#+}} xmm1 = [0,0,4294967295,4294967295]
; X64-SSE2-NEXT:    por %xmm0, %xmm1
; X64-SSE2-NEXT:    pxor {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm1
; X64-SSE2-NEXT:    movdqa {{.*#+}} xmm2 = [2147483647,2147483647,u,u]
; X64-SSE2-NEXT:    pcmpgtd %xmm1, %xmm2
; X64-SSE2-NEXT:    pcmpeqd %xmm3, %xmm3
; X64-SSE2-NEXT:    pxor %xmm2, %xmm3
; X64-SSE2-NEXT:    pcmpgtd {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm1
...
; X86-SSE4:       # %bb.0:
; X86-SSE4-NEXT:    por {{\.?LCPI[0-9]+_[0-9]+}}, %xmm0
; X86-SSE4-NEXT:    pshufd {{.*#+}} xmm1 = xmm0[1,1,1,1]
; X86-SSE4-NEXT:    pminud %xmm0, %xmm1
; X86-SSE4-NEXT:    movd %xmm1, %eax
; X86-SSE4-NEXT:    retl
;
; X64-SSE4-LABEL: test_v2i32:
; X64-SSE4:       # %bb.0:
; X64-SSE4-NEXT:    por {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0
...
; X64-AVX1:       # %bb.0:
; X64-AVX1-NEXT:    vpor {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
...
; X86-AVX2:       # %bb.0:
; X86-AVX2-NEXT:    vpor {{\.?LCPI[0-9]+_[0-9]+}}, %xmm0, %xmm0
...
; X64-AVX2:       # %bb.0:
; X64-AVX2-NEXT:    vpor {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
