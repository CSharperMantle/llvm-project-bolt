...
; RUN: %python %p/print_btf.py %t2 | FileCheck %s --check-prefix=ENABLED
; RUN: opt < %s -passes=asan -asan-instrumentation-with-call-threshold=0 -S | llc -mtriple=bpfel -filetype=asm -o - | FileCheck %s --check-prefix=DISABLED
...
; ENABLED-NOT: __asan_store4

; DISABLED: call __asan_load4
; DISABLED-NOT: .section        .BTF,"",@progbits
; DISABLED-NOT: .section        .BTF.ext,"",@progbits
