...
; CHECK-NEXT:    [[WIDE_GEP3:%.*]] = getelementptr i32, <4 x ptr> [[TMP0]], <4 x i64> splat (i64 1), !dbg [[DBG26:![0-9]+]]
...
; CHECK-NEXT:    [[WIDE_GEP4:%.*]] = getelementptr i32, <4 x ptr> [[TMP0]], <4 x i64> splat (i64 2), !dbg [[DBG26]]
...
; CHECK-NEXT:    [[WIDE_GEP5:%.*]] = getelementptr i32, <4 x ptr> [[TMP0]], <4 x i64> splat (i64 3), !dbg [[DBG26]]
...
; CHECK-NEXT:    [[TMP1:%.*]] = icmp eq <4 x i64> [[TMP4]], splat (i64 5), !dbg [[DBG28:![0-9]+]]
; CHECK-NEXT:    [[TMP2:%.*]] = extractelement <4 x i1> [[TMP1]], i64 0, !dbg [[DBG29:![0-9]+]]
; CHECK-NEXT:    br i1 [[TMP2]], label %[[VECTOR_LATCH]], label %[[FOR_COND5_PREHEADER1]], !dbg [[DBG29]]
; CHECK:       [[VECTOR_LATCH]]:
