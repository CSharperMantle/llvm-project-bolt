...
; CHECK-NEXT:    [[WIDE_GEP:%.*]] = getelementptr inbounds [10 x [10 x i32]], ptr @d, <16 x i64> zeroinitializer, <16 x i64> [[VEC_IND]]
; CHECK-NEXT:    [[TMP12:%.*]] = add nsw <16 x i64> [[TMP10]], [[VEC_IND3]]
; CHECK-NEXT:    [[TMP13:%.*]] = getelementptr inbounds [10 x i32], <16 x ptr> [[WIDE_GEP]], <16 x i64> [[TMP12]], <16 x i64> zeroinitializer
...
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr inbounds [10 x i32], <16 x ptr> [[WIDE_GEP]], <16 x i64> [[TMP15]], <16 x i64> zeroinitializer
...
; CHECK-NEXT:    [[WIDE_GEP15:%.*]] = getelementptr inbounds [10 x [10 x i32]], ptr @d, <8 x i64> zeroinitializer, <8 x i64> [[VEC_IND15]]
; CHECK-NEXT:    [[TMP20:%.*]] = add nsw <8 x i64> [[TMP18]], [[VEC_IND20]]
; CHECK-NEXT:    [[TMP21:%.*]] = getelementptr inbounds [10 x i32], <8 x ptr> [[WIDE_GEP15]], <8 x i64> [[TMP20]], <8 x i64> zeroinitializer
...
; CHECK-NEXT:    [[TMP24:%.*]] = getelementptr inbounds [10 x i32], <8 x ptr> [[WIDE_GEP15]], <8 x i64> [[TMP23]], <8 x i64> zeroinitializer
...
; CHECK-NEXT:    [[WIDE_GEP36:%.*]] = getelementptr inbounds [10 x [10 x i32]], ptr @d, <16 x i64> zeroinitializer, <16 x i64> [[VEC_IND35]]
; CHECK-NEXT:    [[TMP32:%.*]] = add nsw <16 x i64> [[TMP30]], [[VEC_IND37]]
; CHECK-NEXT:    [[TMP33:%.*]] = getelementptr inbounds [10 x i32], <16 x ptr> [[WIDE_GEP36]], <16 x i64> [[TMP32]], <16 x i64> zeroinitializer
...
; CHECK-NEXT:    [[TMP37:%.*]] = getelementptr inbounds [10 x i32], <16 x ptr> [[WIDE_GEP36]], <16 x i64> [[TMP36]], <16 x i64> zeroinitializer
...
; CHECK-NEXT:    [[INDEX61:%.*]] = phi i64 [ [[VEC_EPILOG_RESUME_VAL44]], %[[VEC_EPILOG_PH45]] ], [ [[INDEX_NEXT74:%.*]], %[[VEC_EPILOG_VECTOR_BODY56]] ]
...
; CHECK-NEXT:    [[WIDE_GEP66:%.*]] = getelementptr inbounds [10 x [10 x i32]], ptr @d, <8 x i64> zeroinitializer, <8 x i64> [[VEC_IND65]]
; CHECK-NEXT:    [[TMP46:%.*]] = add nsw <8 x i64> [[TMP44]], [[VEC_IND70]]
; CHECK-NEXT:    [[TMP47:%.*]] = getelementptr inbounds [10 x i32], <8 x ptr> [[WIDE_GEP66]], <8 x i64> [[TMP46]], <8 x i64> zeroinitializer
...
; CHECK-NEXT:    [[TMP51:%.*]] = getelementptr inbounds [10 x i32], <8 x ptr> [[WIDE_GEP66]], <8 x i64> [[TMP50]], <8 x i64> zeroinitializer
...
; CHECK-NEXT:    [[BC_RESUME_VAL74:%.*]] = phi i64 [ [[IND_END54]], %[[VEC_EPILOG_MIDDLE_BLOCK63]] ], [ [[IND_END41]], %[[VEC_EPILOG_ITER_CHECK43]] ], [ 8, %[[ITER_CHECK22]] ]
; CHECK-NEXT:    [[BC_RESUME_VAL75:%.*]] = phi i64 [ [[TMP43]], %[[VEC_EPILOG_MIDDLE_BLOCK63]] ], [ [[TMP29]], %[[VEC_EPILOG_ITER_CHECK43]] ], [ 0, %[[ITER_CHECK22]] ]
; CHECK-NEXT:    br label %[[FOR_BODY_US:.*]]
; CHECK:       [[FOR_BODY_US]]:
; CHECK-NEXT:    [[INDVARS_IV78:%.*]] = phi i64 [ [[INDVARS_IV_NEXT79:%.*]], %[[FOR_COND_CLEANUP4_US_LCSSA_US_US:.*]] ], [ [[BC_RESUME_VAL74]], %[[VEC_EPILOG_SCALAR_PH42]] ]
; CHECK-NEXT:    [[INDVARS_IV70:%.*]] = phi i64 [ [[INDVARS_IV_NEXT71:%.*]], %[[FOR_COND_CLEANUP4_US_LCSSA_US_US]] ], [ [[BC_RESUME_VAL75]], %[[VEC_EPILOG_SCALAR_PH42]] ]
