...
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP28:%.*]] = shl i64 [[STRIDE]], 3
...
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP33:%.*]] = call <vscale x 2 x i32> @llvm.stepvector.nxv2i32()
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP24:%.*]] = icmp ult <vscale x 2 x i32> [[TMP33]], [[BROADCAST_SPLAT]]
; NO-UNIT-STRIDE-MV-NEXT:    [[OFFSET_IDX:%.*]] = add i64 1, [[INDEX]]
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP34:%.*]] = mul i64 [[OFFSET_IDX]], [[STRIDE]]
...
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP29:%.*]] = getelementptr i64, ptr [[P_STRIDED]], i64 [[TMP34]]
...
; NO-UNIT-STRIDE-MV-NEXT:    [[TMP35:%.*]] = trunc i64 [[TMP27]] to i32
; NO-UNIT-STRIDE-MV-NEXT:    [[WIDE_MASKED_GATHER22:%.*]] = call <vscale x 2 x i64> @llvm.experimental.vp.strided.load.nxv2i64.p0.i64(ptr align 8 [[TMP29]], i64 [[TMP28]], <vscale x 2 x i1> [[TMP24]], i32 [[TMP35]]), !alias.scope [[META3:![0-9]+]]
