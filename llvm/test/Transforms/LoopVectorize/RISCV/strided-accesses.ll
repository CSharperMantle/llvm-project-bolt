...
; CHECK-NEXT:    [[TMP15:%.*]] = getelementptr i8, ptr [[P]], i64 [[TMP8]]
...
; CHECK-UF2-NEXT:    [[TMP18:%.*]] = getelementptr i8, ptr [[P]], i64 [[TMP16]]
; CHECK-UF2-NEXT:    [[TMP17:%.*]] = mul i64 [[TMP3]], 256
; CHECK-UF2-NEXT:    [[TMP14:%.*]] = getelementptr i8, ptr [[TMP18]], i64 [[TMP17]]
...
; CHECK-NEXT:    [[TMP9:%.*]] = getelementptr nuw i8, ptr [[IN]], i64 [[TMP3]]
...
; CHECK-UF2:       [[VECTOR_BODY]]:
; CHECK-UF2-NEXT:    [[INDEX:%.*]] = phi i64 [ 0, %[[VECTOR_PH]] ], [ [[INDEX_NEXT:%.*]], %[[VECTOR_BODY]] ]
; CHECK-UF2-NEXT:    [[TMP12:%.*]] = shl nuw i64 [[INDEX]], 2
; CHECK-UF2-NEXT:    [[TMP5:%.*]] = getelementptr nuw i8, ptr [[IN]], i64 [[TMP12]]
; CHECK-UF2-NEXT:    [[TMP13:%.*]] = mul i64 [[TMP3]], 4
; CHECK-UF2-NEXT:    [[TMP6:%.*]] = getelementptr inbounds nuw i8, ptr [[TMP5]], i64 [[TMP13]]
