...
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds [1024 x i64], ptr @A, <4 x i64> zeroinitializer, <4 x i64> [[VEC_IND]]
...
; CHECK-NEXT:    [[TMP1:%.*]] = getelementptr inbounds [1024 x i64], ptr @B, <4 x i64> zeroinitializer, <4 x i64> [[VEC_PHI]]
