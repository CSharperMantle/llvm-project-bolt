...
; CHECK-NEXT:    [[TMP0:%.*]] = getelementptr inbounds [1024 x i32], ptr @A, <4 x i64> zeroinitializer, <4 x i64> [[VEC_IND]]
...
; CHECK-NEXT:    [[TMP4:%.*]] = getelementptr inbounds [1024 x i32], ptr @B, <4 x i64> zeroinitializer, <4 x i64> [[TMP2]]
