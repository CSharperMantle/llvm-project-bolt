...
; CHECK-NEXT:    [[TMP10:%.*]] = getelementptr inbounds [1024 x float], ptr @A, <vscale x 4 x i64> zeroinitializer, <vscale x 4 x i64> [[VEC_IND]]
...
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr inbounds [512 x float], ptr @B, <vscale x 4 x i64> zeroinitializer, <vscale x 4 x i64> [[VEC_PHI]]
