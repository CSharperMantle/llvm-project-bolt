...
; RV32-NEXT:    [[TMP25:%.*]] = call <vscale x 2 x i32> @llvm.stepvector.nxv2i32()
; RV32-NEXT:    [[TMP15:%.*]] = icmp ult <vscale x 2 x i32> [[TMP25]], [[BROADCAST_SPLAT10]]
; RV32-NEXT:    [[TMP16:%.*]] = shl i64 [[INDEX]], 4
; RV32-NEXT:    [[TMP26:%.*]] = getelementptr inbounds i32, ptr [[TRIGGER]], i64 [[TMP16]]
; RV32-NEXT:    [[TMP27:%.*]] = trunc i64 [[TMP13]] to i32
; RV32-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <vscale x 2 x i32> @llvm.experimental.vp.strided.load.nxv2i32.p0.i64(ptr align 4 [[TMP26]], i64 64, <vscale x 2 x i1> [[TMP15]], i32 [[TMP27]]), !alias.scope [[META0:![0-9]+]], !noalias [[META3:![0-9]+]]
; RV32-NEXT:    [[TMP14:%.*]] = icmp slt <vscale x 2 x i32> [[WIDE_MASKED_GATHER]], splat (i32 100)
; RV32-NEXT:    [[TMP20:%.*]] = call <vscale x 2 x i1> @llvm.vp.merge.nxv2i1(<vscale x 2 x i1> splat (i1 true), <vscale x 2 x i1> [[TMP14]], <vscale x 2 x i1> zeroinitializer, i32 [[TMP10]])
; RV32-NEXT:    [[TMP28:%.*]] = shl nuw nsw i64 [[TMP16]], 1
; RV32-NEXT:    [[TMP29:%.*]] = getelementptr inbounds double, ptr [[B]], i64 [[TMP28]]
; RV32-NEXT:    [[TMP30:%.*]] = trunc i64 [[TMP13]] to i32
; RV32-NEXT:    [[WIDE_MASKED_GATHER6:%.*]] = call <vscale x 2 x double> @llvm.experimental.vp.strided.load.nxv2f64.p0.i64(ptr align 8 [[TMP29]], i64 256, <vscale x 2 x i1> [[TMP20]], i32 [[TMP30]]), !alias.scope [[META5:![0-9]+]]
...
; RV64-NEXT:    [[TMP12:%.*]] = call <vscale x 2 x i32> @llvm.stepvector.nxv2i32()
; RV64-NEXT:    [[TMP20:%.*]] = icmp ult <vscale x 2 x i32> [[TMP12]], [[BROADCAST_SPLAT7]]
; RV64-NEXT:    [[TMP9:%.*]] = shl i64 [[INDEX]], 4
; RV64-NEXT:    [[TMP25:%.*]] = getelementptr inbounds i32, ptr [[TRIGGER]], i64 [[TMP9]]
; RV64-NEXT:    [[TMP11:%.*]] = trunc i64 [[TMP2]] to i32
; RV64-NEXT:    [[WIDE_MASKED_GATHER:%.*]] = call <vscale x 2 x i32> @llvm.experimental.vp.strided.load.nxv2i32.p0.i64(ptr align 4 [[TMP25]], i64 64, <vscale x 2 x i1> [[TMP20]], i32 [[TMP11]]), !alias.scope [[META0:![0-9]+]]
; RV64-NEXT:    [[TMP14:%.*]] = icmp slt <vscale x 2 x i32> [[WIDE_MASKED_GATHER]], splat (i32 100)
; RV64-NEXT:    [[TMP13:%.*]] = call <vscale x 2 x i1> @llvm.vp.merge.nxv2i1(<vscale x 2 x i1> splat (i1 true), <vscale x 2 x i1> [[TMP14]], <vscale x 2 x i1> zeroinitializer, i32 [[TMP10]])
; RV64-NEXT:    [[TMP26:%.*]] = shl nuw nsw i64 [[TMP9]], 1
; RV64-NEXT:    [[TMP15:%.*]] = getelementptr inbounds double, ptr [[B]], i64 [[TMP26]]
; RV64-NEXT:    [[TMP16:%.*]] = trunc i64 [[TMP2]] to i32
; RV64-NEXT:    [[WIDE_MASKED_GATHER6:%.*]] = call <vscale x 2 x double> @llvm.experimental.vp.strided.load.nxv2f64.p0.i64(ptr align 8 [[TMP15]], i64 256, <vscale x 2 x i1> [[TMP13]], i32 [[TMP16]]), !alias.scope [[META3:![0-9]+]]
