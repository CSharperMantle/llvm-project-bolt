...
; CHECK-NEXT:    [[WIDE_GEP:%.*]] = getelementptr inbounds nuw i8, <4 x ptr> [[VECTOR_GEP4]], <4 x i32> splat (i32 1)
...
; CHECK-NEXT:    [[WIDE_GEP4:%.*]] = getelementptr inbounds nuw i8, <4 x ptr> [[VECTOR_GEP4]], <4 x i32> splat (i32 2)
; CHECK-NEXT:    [[WIDE_MASKED_GATHER5:%.*]] = call <4 x i8> @llvm.masked.gather.v4i8.v4p0(<4 x ptr> align 1 [[WIDE_GEP]], <4 x i1> [[ACTIVE_LANE_MASK]], <4 x i8> poison), !alias.scope [[META0]]
; CHECK-NEXT:    [[WIDE_MASKED_GATHER6:%.*]] = call <4 x i8> @llvm.masked.gather.v4i8.v4p0(<4 x ptr> align 1 [[WIDE_GEP4]], <4 x i1> [[ACTIVE_LANE_MASK]], <4 x i8> poison), !alias.scope [[META0]]
...
; CHECK-NEXT:    [[WIDE_GEP7:%.*]] = getelementptr inbounds nuw i8, <4 x ptr> [[VECTOR_GEP]], <4 x i32> splat (i32 1)
...
; CHECK-NEXT:    [[WIDE_GEP8:%.*]] = getelementptr inbounds nuw i8, <4 x ptr> [[VECTOR_GEP]], <4 x i32> splat (i32 2)
; CHECK-NEXT:    call void @llvm.masked.scatter.v4i8.v4p0(<4 x i8> [[TMP21]], <4 x ptr> align 1 [[WIDE_GEP7]], <4 x i1> [[ACTIVE_LANE_MASK]]), !alias.scope [[META3]], !noalias [[META0]]
; CHECK-NEXT:    call void @llvm.masked.scatter.v4i8.v4p0(<4 x i8> [[TMP29]], <4 x ptr> align 1 [[WIDE_GEP8]], <4 x i1> [[ACTIVE_LANE_MASK]]), !alias.scope [[META3]], !noalias [[META0]]
